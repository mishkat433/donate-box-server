...
router.post("/create-admin", (0, validateRequest_1.default)(admin_validation_1.adminZodValidation.createAdminZodSchema), admin_controller_1.adminController.createAdminHandler);
